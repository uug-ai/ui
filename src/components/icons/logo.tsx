...
import { cn } from "../../utils"; // Ensure cn utility function handles class concatenation
...
type LogoProps = SVGProps<SVGSVGElement> & VariantProps<typeof logoVariants>;

const Logo = ({ size, color, className, ...props }: LogoProps) => {
  return (
    <svg
